class CustomersController < ApplicationController
  ...
  def index
    ...
    @customers = @q.result.includes(:address, :devices).order('devices.purchased_at asc', :name).paginate(page: params[:page], per_page: 10)
  end
  ...
  private
    ...
    def customer_params
      params.require(:customer).permit(:name, :email, :phone, :type, :cpf, :rg,
        :dob, :cellphone, :cnpj, :state_registration, :gender, :career, :re,
